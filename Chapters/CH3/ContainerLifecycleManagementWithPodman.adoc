...
KillMode=none
Type=forking
PIDFile=/run/user/1000/overlay-containers/a4b6429a3108095e1fdf1c509e105132f96a2a1da2eb2ce38614283f1151fb59/userdata/conmon.pid
...
CONTAINER ID  IMAGE                                                   COMMAND               CREATED      STATUS            PORTS  NAMES
a4b6429a3108  registry.access.redhat.com/rhscl/httpd-24-rhel7:latest  /usr/bin/run-http...  5 hours ago  Up 8 seconds ago         myhttpd
